---
title: VfxLegacyRenderComponent
description: Reference documentation for VfxLegacyRenderComponent meta class
since: "15.10"
---

import ClassDetails from '../../../components/ClassDetails.astro';

<ClassDetails file="/db/classes/VfxLegacyRenderComponent.0aa8709ada52.json" />
